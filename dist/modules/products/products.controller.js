...
let ProductsController = class ProductsController {
    ...
    findAll(type, categoryId, active, search) {
    ...
    addSupplier(productId, supplierData) {
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: "Agregar proveedor a producto" }),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Obtener proveedores de un producto' }),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
